...
final class Test_ServerConverterExtensions: Test_Runtime {
    ...
    func test_getOptionalQueryItemAsURI_deepObject_exploded() throws {
        let query: Substring = "sort%5Bid%5D=ascending&sort%5Bname%5D=descending&unrelated=foo"
    ...
    func test_getOptionalQueryItemAsURI_deepObject_exploded_empty() throws {
        let query: Substring = "foo=bar"
        let value: [String: String]? = try converter.getOptionalQueryItemAsURI(
            in: query,
            style: .deepObject,
            explode: true,
    ...
    func test_getRequiredQueryItemAsURI_deepObject_exploded() throws {
        let query: Substring = "sort%5Bid%5D=ascending&unrelated=foo&sort%5Bname%5D=descending"
