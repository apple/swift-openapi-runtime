...
final class Test_URISerializer: Test_Runtime {
    ...
    func testTranslating() throws {
        ...
        func makeCase(_ value: URINode, _ expectedString: String, file: StaticString = #file, line: UInt = #line)
            -> Case
        {
            .init(value: value, expectedString: expectedString, file: file, line: line)
        }

        let cases: [Case] = [
            makeCase(.primitive(.string("")), "root="),
